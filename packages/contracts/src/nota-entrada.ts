...
// Espelho read-only do ERP, irmão de `nota-saida.ts`: sem create/update — as
// notas de compra entram só pela API de integração.
//
// Sem os campos de NF-e da saída (`situacaoNfe`, `protocoloNfe`, `temXml`): o
// documento de entrada é do fornecedor, e a plataforma não reimprime segunda
// via de nota de terceiro.
