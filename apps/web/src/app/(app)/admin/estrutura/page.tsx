        ...
        <form onSubmit={form.handleSubmit(onSubmit)} noValidate>
          ...
          <FieldGroup className="py-4">
            ...
            <Field>
              ...
              <Input id="rota" placeholder="/comercial/colaboradores" {...form.register("rota")} />
            </Field>
            <Field>
              <FieldLabel htmlFor="icone">Ícone (lucide-react)</FieldLabel>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} noValidate>
          ...
          <FieldGroup className="py-4">
            ...
            <Field data-invalid={!!form.formState.errors.codigo}>
              ...
              <Input id="codigo" placeholder="colaboradores" disabled={!!editing} {...form.register("codigo")} />
              <FieldDescription>
                Identificador único usado nas permissões (ex.: <code>colaboradores.editar</code>). Não pode ser
